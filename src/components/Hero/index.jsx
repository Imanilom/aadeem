      ...
      <div className="flex flex-col gap-[44px] p-5 py-6  min-h-screen h-auto justify-center md:p-0 lg:px-10 lg:pt-10 lg:pb-20 lg:min-h-fit lg:items-center lg:flex-row lg:justify-between lg:gap-5 overflow-hidden">
        <motion.div initial="hidden" animate="visible" variants={containerContent} className="flex flex-col items-center lg:items-start gap-8 lg:w-full lg:gap-[34px]">
          <section className="flex flex-col gap-5 sm:items-center text-center lg:text-left lg:gap-6 lg:items-start">
            <h4 className="text-[42px] leading-[52px] sm:w-4/5 md:text-5xl md:w-4/5 font-bold font-head text-primary-100 lg:text-3xl lg:leading-[40px]">
              Kenyamanan Tak Tertandingi dengan Singlet Katun Bambu: Lembut, Sejuk, dan Ramah Lingkungan
            </h4>
            <p className="text-lg font-body text-black-300 sm:w-4/5">
            Rasakan kesegaran alami setiap hari dengan Singlet Katun Bambu kami! Terbuat dari 100% serat bambu organik pilihan, singlet ini memberikan sensasi lembut yang memanjakan kulit Anda.
            </p>
          </section>
        </motion.div>
        <motion.div
          ...
          <div className="relative w-fit">
            ...
            >
              ...
              <img
                ...
                src="/images/FPK202311049.jpg"
                alt="chair"
              />
              <div className="flex w-full items-center justify-between">
                <p>Singlet Man</p>
                <p className="text-[#515151] font-medium">Rp69.000</p>
              </div>
              <a href="https://tokopedia.link/SPGdrt3CeKb">
